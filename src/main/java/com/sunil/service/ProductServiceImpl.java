...
public class ProductServiceImpl {
	...
	public List<Product> getListOfProduct(Connection con) throws SQLException {
		...
		PreparedStatement ps = con.prepareStatement("select p.id,p.p_code,p.p_description,p.p_price,pc.category_name,p.p_path from product p, product_categories pc where p.p_category_id=pc.id");
