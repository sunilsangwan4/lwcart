		...
		<table class="table">
			...
			<c:forEach items="${products}" var="plist">
				<tr>
					...
					<td><img src="file://${plist.pPath } " /></td>



					<td><a class="btn btn-block btn-warning btn-sm"
						href="${pageContext.request.contextPath}/BuyProduct?productId=${plist.id}">Buy
							Now </a></td>
					<td><a class="btn btn-block btn-warning disabled"
						href="${pageContext.request.contextPath}/AddCart?productId=${plist.id}">Add
							to Cart </a></td>
