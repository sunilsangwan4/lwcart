...
<title>lwseckCart | vendorLog in</title>
...
<body class="hold-transition login-page">
	<div class="login-box">
		<div class="login-logo">
			<a href="../../index2.html"><b>lwseck</b>CART</a>
		</div>
		<!-- /.login-logo -->
		<div class="login-box-body">
			<p class="login-box-msg">Sign in to start your session</p>

			<form action="${pageContext.request.contextPath}/vendorLogin"
				method="post">
			...
			<a href="#">I forgot my password</a><br> <a
				href="vendorRegistration.jsp" class="text-center">Register a new
				membership</a>
